...
class Movies(models.Model):
    ...
    release_time = models.CharField(max_length=10, null=False)
    genre = models.CharField(max_length=20, null=False)
    producer = models.CharField(max_length=10, null=False)
    status = models.BooleanField(default=True)
    admin = models.ForeignKey(Admins, on_delete=models.CASCADE, db_column='admin_id')
...
class User(models.Model):
    ...
    movie = models.ForeignKey(Movies, on_delete=models.CASCADE, db_column='movie_id', null=True)
    class Meta:
        db_table = 'user'
#影评记录
